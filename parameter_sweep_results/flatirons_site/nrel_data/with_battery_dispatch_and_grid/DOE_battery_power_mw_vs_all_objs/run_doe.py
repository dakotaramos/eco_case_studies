...
if __name__ == "__main__":
    # build the model
    prob = om.Problem()
    prob.model.add_subsystem('hybrid_system', HybridSystem(location=flatirons_site, resource_api='nrel', battery=True, grid=True), promotes=['*'])
    ...
    # Battery DVs
    # prob.model.add_design_var('battery_capacity_mwh', lower=0., upper=10000.)
